...
<div class="container mt-4">
    ...
    <form id="marksheetForm" action="{{ route('marksheet.generateMultiple') }}" method="POST">
        @csrf
        <div class="row mb-3">
            <div class="col-md-4">
                ...
                <select id="courseSelect" class="form-select" required>
                    ...
                    @foreach($courses as $course)
                        @if (stripos($course->name, 'ETO') !== false || stripos($course->name, 'GME') !== false)
        ...
        <button id="generateBtn" class="btn btn-primary" disabled type="submit">Generate Marksheet ZIP</button>
    </form>
</div>
<script>
