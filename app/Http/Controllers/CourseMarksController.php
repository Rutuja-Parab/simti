...
class CourseMarksController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return back()->with('error', 'Failed to load courses. Please check the logs for details.');
        }
    }
    ...
    public function edit($courseId)
    {
        try {
            ...
            return redirect()->route('course.marks.index')->with('error', 'Failed to load the marks entry form. Please check the logs for details.');
        }
    }
    ...
    public function store(Request $request, $courseId)
    {
        ...
        try {
            $request->validate([
                ...
                'marks.*.*' => 'nullable|numeric|min:0|max:100', // Adjust max value as needed
            ]);
            ...
            Log::warning('Validation error in store method: ' . $e->getMessage());
            return back()->withErrors($e->errors())->withInput();
        } catch (\Exception $e) {
            Log::error('Error in store method: ' . $e->getMessage());
            return back()->with('error', 'Failed to save marks. Please check the logs for details.');
        }
    }
    ...
    public function marksheetWizard()
    {
        try {
            ...
            Log::error('Error in marksheetWizard method: ' . $e->getMessage());
            return back()->with('error', 'Failed to load the marksheet wizard. Please check the logs for details.');
        }
    }
    ...
    public function getBatchesForCourse($courseId)
    {
        try {
            ...
            Log::error('Error in getBatchesForCourse method: ' . $e->getMessage());
            return response()->json(['error' => 'Failed to load batches. Please check the logs for details.'], 500);
        }
    }
    ...
    public function getCandidatesForBatch($batchId)
    {
        try {
            ...
            Log::error('Error in getCandidatesForBatch method: ' . $e->getMessage());
            return response()->json(['error' => 'Failed to load candidates. Please check the logs for details.'], 500);
        }
    }
    ...
    public function generateEtoMarksheet($candidateId)
    {
        try {
            ...
            Log::error('Error in generateEtoMarksheet method: ' . $e->getMessage());
            return back()->with('error', 'Failed to generate the marksheet. Please check the logs for details.');
        }
    }
    ...
    public function generateMultipleMarksheets(Request $request)
    {
        ...
        try {
            ...
            Log::warning('Validation error in generateMultipleMarksheet method: ' . $e->getMessage());
            return back()->withErrors($e->errors())->withInput();
        } catch (\Exception $e) {
            Log::error('Error in generateMultipleMarksheets method: ' . $e->getMessage());
            return back()->with('error', 'Failed to generate multiple marksheets. Please check the logs for details.');
        }
    }
}